...
type PropsType = {
    ...
    removeTodo:(todolistsID: string)=>void
}
...
export function Todolist(props: PropsType) {
    ...
    const onClickHundlerRemoveTodoList= () => {
        props.removeTodo(props.todolistsID )
    }

    return <div>
        <h3>{props.title}</h3>
        <button onClick={onClickHundlerRemoveTodoList}>X</button>
        <div>
            <input value={title}
