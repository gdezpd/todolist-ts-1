...
export function Todolist(props: PropsType) {
    ...
    const editTitleTodolistHundler = (title: string) => {
        props.editTitleTodolist(props.id, title)
    }
    const editTitleTaskHundler =  (taskId: string, title: string)=>{
    ...
    return <div>
        <h3>
            <EditableSpan
                collBack={editTitleTodolistHundler}
                title={props.title}/>
                ...
                props.tasks.map(t => {
                    ...
                    return <li key={t.id} className={t.isDone ? "is-done" : ""}>
                        ...
                        <EditableSpan title={t.title}
                                      collBack={(title)=>editTitleTaskHundler(t.id, title)}
                        />
